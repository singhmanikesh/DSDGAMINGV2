...
import schoolsImage from '../../assets/school.png';
...
export function SchoolsPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error('Schools contact form failed:', error);
